...
public class LoginPageTest extends BaseTest {
    ...
    public void verifyTheErrorMessageWithInValidCredentials(){
        ...
        homePage.clickOnLoginLink();
        //Enter EmailId
        loginPage.enterEmailId("paragpatel66@gmail.com");
        //Enter Password
        loginPage.enterPassword("parag100");
    ...
    public void verifyThatUserShouldLogInSuccessFullyWithValidCredentials() throws InterruptedException {
        ...
        homePage.clickOnLoginLink();
        // enter email id
        loginPage.enterEmailId("Siddh10@gmail.com");
        // enter password
        loginPage.enterPassword("Siddh1002");
        Thread.sleep(3000);
        //click on login button
        loginPage.clickOnLoginButton();
        Thread.sleep(3000);
