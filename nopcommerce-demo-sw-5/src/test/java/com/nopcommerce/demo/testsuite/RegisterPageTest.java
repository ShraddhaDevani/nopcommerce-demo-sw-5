...
public class RegisterPageTest extends BaseTest {
    ...
    public static String email = getRandomString(6) + "@gmail.com";
    ...
    public void verifyThatUserShouldCreateAccountSuccessfully() throws InterruptedException {
        ...
        registerPage.selectDateOfBirth("30", "March", "2004");
        //enter email
        registerPage.enterEmail(email);
        Thread.sleep(3000);
        // enter password
        registerPage.enterPassword("mirashah@2030");
        Thread.sleep(3000);
        // enter confirm password
        registerPage.enterConfirmPassword("mirashah@2030");
        // click on  REGISTER BUTTON
        registerPage.clickOnRegisterButton();
        Thread.sleep(3000);
